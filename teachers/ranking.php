...
if (isset($_POST['ranking'])) {
    ...
    $sport = $_POST['sport'];
    $sql = "SELECT * FROM students INNER JOIN events ON students.sportsClass = events.e_id WHERE sportsClass = $sport";
...
if (isset($_POST['submit'])) {
    ...
    $eRanking = $_POST['eventRaking'];
    $sid = $_POST['sid'];

  $sql2 = "UPDATE students SET ranking = '$eRanking' WHERE id =$sid";
    $result2 = $conn->query($sql2);

    $success .= "ranking added successfully";
                ...
                <div class="col-10 bg-light">
                    ...
                    <div class="dashboard-content m-3 p-3  rounded">
                        <div class="row">
                            ...
                            <div>
                                <p class="text-success py-3"><?php echo $success; ?></p>
                            </div>
                        </div>
                        <div class="row">
                            <h3>Rankings</h3>
                                ...
                                ?>
                                    <tr>
                                        <form action="<?php $_SERVER["PHP_SELF"];?>" method="POST">
                                            ...
                                            <td>
                                                <select class="form-select" name="eventRaking"
                                                    aria-label="Default select example">
                                                    <option disabled selected>Open select ranks</option>
