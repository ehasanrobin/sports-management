...
if (isset($_POST['submit'])) {
  ...
  if($result == true){
   $_SESSION['email'] = $email; 
    ...
    $success = "account successfully created wait for the activation";
  }else {
...
<body>
    <section class="">
        <div class="container-fluid h-custom ">
            <div class="row d-flex justify-content-center align-items-center register-section">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST">
                        ...
                        <div class="form-outline mb-4">
                            <input type="name" name="name" id="form3Example3" required
                        ...
                        <div>
                            ...
                            if($success){
                            ?>
                            <p class="text-success alert alert-success bg-dark">
                                <?php echo $success;   ?> </p>
                            <?php
                            }
                            ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="./index.php" class="text-body">login?</a>
                        </div>
        ...
        <div
            ...
            <div class="text-white mb-3 mb-md-0">
                Copyright © 2022. All rights reserved by Md. Aminur Islam, Milon Mia, Rahmat Ali.
            </div>
            <!-- Copyright -->
