...
if (isset($_POST['submit'])) {
   ...
   $sql = "INSERT INTO `students`(`name`, `email`, `sportsClass`, `ranking`) VALUES ('$first_name','$email',' $sports','$result')";
                        ...
                        <div class="row">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="name" name="sname" required class="form-control"
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Sports</label>
