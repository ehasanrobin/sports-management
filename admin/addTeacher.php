...
if (isset($_POST['submit'])) {
    ...
    $first_name = $_POST['tname'];
    $email = $_POST['email'];
    $password = $_POST['password'];
   
   
   $sql = "INSERT INTO `teachers`(`name`, `email`,`password`) VALUES ('$first_name','$email','$password')";
                        ...
                        <div class="row">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="name" name="tname" required class="form-control"
