...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `events`(`eventName`, `type`,`e_teacher`) VALUES ('$eName','$type',$eTeacher)";
   $result = $conn->query($sql);
                        ...
                        <div class="row">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Event Techer</label>
                                            <select class="form-select" name="eTeacher" required
                                                aria-label="Default select example">
                                                <option disabled selected>Open this select menu </option>
                                                <?php
                                         ...
                                         if($msg !== "") {
                                        ?>
                                                <p class="p-3 text-white bg-primary my-3 rounded"><?php echo $msg ;?>
                                                </p>
                                                <?php };?>
                                            </div>
                                        </div>
