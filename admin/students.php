...
$sql = "SELECT * FROM students INNER JOIN events ON students.sportsClass = events.e_id";
...
if (isset($_POST['etype'])) {
    ...
    $sport = $_POST['type'];
    $sql = "SELECT * FROM students INNER JOIN events ON students.sportsClass = events.e_id WHERE type = '$sport'" ;
                    ...
                    <div class="dashboard-content m-3 p-3  rounded">
                        <div class="row">
                            ...
                            <form action="<?php $_SERVER["PHP_SELF"];?>" method="POST">
                                ...
                                <input type="submit" name="etype" class="btn form-control btn-primary mt-3"
                                    value="search">
                            </form>
                            <table class="table">
                                <thead>
